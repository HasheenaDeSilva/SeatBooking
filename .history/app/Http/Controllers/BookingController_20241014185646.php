    ...
    public function store(Request $request)
{
    ...
    $validatedData = $request->validate([
        ...
        'intern_name' => 'required|string|max:255', // Ensure intern_name is required
        'date' => 'required|date',
    ...
    // Create the booking, including the intern_id, intern_name, and seat_number
    Booking::create([
        'intern_id' => $request->intern_id,
        'intern_name' => $request->intern_name, // Include intern_name here
        'date' => $request->date,
