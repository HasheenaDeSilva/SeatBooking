...
Route::get('/pages/admin/register', [AdminAuthController::class, 'showRegisterForm'])->name('pages.admin.register');
Route::post('/pages/admin/register', [AdminAuthController::class, 'register'])->name('pages.admin.register.store');
Route::get('/pages/admin/login', [AdminAuthController::class, 'showLoginForm'])->name('pages.admin.login');
